...
## Additional Reflection Questions
 ...
 I feel like the architecture diagram was very helpful. As I build up my game, having a plan like that helped me to navigate what to add into the game. 
 I build classes from big (the overall environment) to small (details to make everything work): maze -> cell -> player -> searchableObject. After all of these details are done, I build my game loop that include the game structure based on those classes from big to small.
 - What **new thing(s)** did you learn / figure out in completing this project?
 I made a whole map! Hia, you helped me so much in making this happen, a 2D list of list of integers is soooo amazing!
