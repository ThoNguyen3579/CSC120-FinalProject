...
class Maze {
     ...
     */
    public Maze(){
        this.listOfCells = new ArrayList<Cell>();
    }
     ...
     * Print a nicely formatted maze for now to keep my sanity
     */
    public void buildMaze(){
        ...
        this.addCellVal(0,1,1,0,false, false);
        this.addCellVal(1,0,1,0,false, false);
        this.addCellVal(1,1,0,0,false, true); // Diamond Room 4
     ...
     /**
     * create searchable objects and then add them into the rooms
     */
    public void addSearchableObject(){
        ...
        // office
        searchableObject safe = new searchableObject("SAFE", "Please enter the password: "); // password: 0717
        ...
        // children's room
        // make phone so that only face id works
        searchableObject phone = new searchableObject("PHONE", "a longggg longg in4", 10);
